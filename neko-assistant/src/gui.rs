...
/// GUI entrypoint. Two builds:
/// - When built with `--features gui`, the real GPUI implementation can be wired here.
/// - When built without the feature, we show a simple console preview of plugin metadata.
